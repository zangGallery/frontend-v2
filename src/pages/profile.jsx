        ...
        <div className="min-h-screen bg-ink-950">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                {error ? (
                    ...
                    <>
                        {/* Profile Header */}
                        <div className="sm:bg-ink-900/50 sm:rounded-2xl sm:border sm:border-ink-800 p-0 sm:p-6 mb-6 sm:mb-8">
                            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                                ...
                                {blockieUrl ? (
                                    ...
                                    <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-xl bg-ink-800 animate-pulse flex-shrink-0" />
                                )}
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                                        <a
                                            ...
                                            className="flex items-center gap-1.5 p-2 sm:px-3 sm:py-1.5 rounded-lg bg-ink-800 text-ink-300 hover:text-white hover:bg-ink-700 transition-colors text-sm"
                                        ...
                                        {profileInfo?.xUsername && (
                                            <a
                                                ...
                                                rel="noopener noreferrer"
                                                className="flex items-center gap-1.5 p-2 sm:px-3 sm:py-1.5 rounded-lg bg-ink-800 text-ink-300 hover:text-white hover:bg-ink-700 transition-colors text-sm"
                                                title={`@${profileInfo.xUsername}`}
                                            >
                                                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                                </svg>
                                                <span className="hidden sm:inline">@{profileInfo.xUsername}</span>
                                            </a>
                                        )}
                                        {profileInfo?.instagramUsername && (
                                            <a
                                                ...
                                                rel="noopener noreferrer"
                                                className="flex items-center gap-1.5 p-2 sm:px-3 sm:py-1.5 rounded-lg bg-ink-800 text-ink-300 hover:text-white hover:bg-ink-700 transition-colors text-sm"
                                                title={`@${profileInfo.instagramUsername}`}
                                            >
                                                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                ...
                                                <span className="hidden sm:inline">@{profileInfo.instagramUsername}</span>
                                            </a>
                                        )}
                                        {profileInfo?.baseUsername && (
                                            <a
                                                ...
                                                rel="noopener noreferrer"
                                                className="flex items-center gap-1.5 p-2 sm:px-3 sm:py-1.5 rounded-lg bg-ink-800 text-ink-300 hover:text-white hover:bg-ink-700 transition-colors text-sm"
                                                title={profileInfo.baseUsername}
                                            >
                                                ...
                                                <span className="hidden sm:inline">{profileInfo.baseUsername}</span>
                                            </a>
                                        )}
                                    </div>
                                </div>
